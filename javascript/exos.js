// 0.
// Write a function that displays "Hello World" in the console (use "console.log")
...
// Use the key word "return" and display the result using "console.log" outside the function
...
// Use the key word "return" and display the couple (max et min) using "console.log" outside the function
...
// Use the key word "return" and display the table using "console.log" outside the function
