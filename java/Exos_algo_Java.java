...
public class Exos_algo_Java {
    // 0.
    // Write a function that displays "Hello World" in the console (use "System.out.println")
    ...
    // Use the key word "return" and display the result using "System.out.println" outside the function
    ...
    // Use the key word "return" and display the couple (max et min) using "System.out.println" outside the function
    ...
    // Use the key word "return" and display the table using "System.out.println" outside the function
